...
BEGIN
	...
	FROM 'C:\Users\tsied\Downloads\SQL course\sql-data-warehouse-project\datasets\source_crm\cust_info.csv'
	...
	FROM 'C:\Users\tsied\Downloads\SQL course\sql-data-warehouse-project\datasets\source_crm\prd_info.csv'
	WITH (FORMAT CSV, DELIMITER ',', HEADER TRUE);
	...
	FROM 'C:\Users\tsied\Downloads\SQL course\sql-data-warehouse-project\datasets\source_crm\sales_details.csv'
	WITH (FORMAT CSV, DELIMITER ',', HEADER TRUE);
	end_time := clock_timestamp();
    elapsed := end_time - start_time;
    ...
    (cid, cntry) 
    FROM 'C:\Users\tsied\Downloads\SQL course\sql-data-warehouse-project\datasets\source_erp\LOC_A101.csv'
    WITH (FORMAT CSV, DELIMITER ',', HEADER TRUE);
    end_time := clock_timestamp();
    elapsed := end_time - start_time;
    ...
    (cid, bdate, gen) 
    FROM 'C:\Users\tsied\Downloads\SQL course\sql-data-warehouse-project\datasets\source_erp\CUST_AZ12.csv'
    WITH (FORMAT CSV, DELIMITER ',', HEADER TRUE);
    end_time := clock_timestamp();
    elapsed := end_time - start_time;
    ...
    FROM 'C:\Users\tsied\Downloads\SQL course\sql-data-warehouse-project\datasets\source_erp\PX_CAT_G1V2.csv'
    WITH (FORMAT CSV, DELIMITER ',', HEADER TRUE);
    end_time := clock_timestamp();
    elapsed := end_time - start_time;
